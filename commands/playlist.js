...
module.exports = {
  ...
  async execute(message, args) {
    ...
    const serverQueue = message.client.queue.get(message.guild.id);
      ...
      .setTitle(`${message.author.tag} Playlist`)
      .setDescription(i18n.__mf("playlist.usageReply", { prefix: message.client.prefix }))
    ...
    let playlistEmbed = new MessageEmbed()
      ...
      let startedPlaylist = new MessageEmbed()
      .setTitle(`${message.author.tag} Playlist`)
      .setDescription(i18n.__("playlist.startedPlaylist"))
      .setFooter('Design : thisgleam', 'https://cdn.discordapp.com/avatars/849261647859417118/bc4c4ddf312dd058c1d2e5bd826f69b4.png?size=2048')
      .setColor("#00BCFF")
      .setTimestamp();
    ...
    message.channel.send(startedPlaylist);
